 ...
 *
 */
public class CamphorDynamicFilterRegistrationLoader extends CamphorAbstractDynamicFileRegistrationLoader implements
    CliviaDynamicFileLoad {

    private static final String dynamic_filter_type = "dynamic-filter";

    private static final CamphorDynamicFilterRegistrationLoader cliviaFilterFileRegistrationLoader =
        new CamphorDynamicFilterRegistrationLoader();

    private static Logger logger = LoggerFactory.getLogger(CamphorDynamicFilterRegistrationLoader.class);

    private static ConcurrentHashMap<String, Long> cliviafilterClassLastModified = new ConcurrentHashMap<String, Long>();

    public static CamphorDynamicFilterRegistrationLoader getCliviaFilterFileRegistrationLoader() {
